...
<template>
  ...
  <div v-if="showRecoveryCode" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
    <div class="bg-[#1E1E1E] border border-[#D2EE5B] rounded-[20px] p-8 max-w-md w-full mx-4 relative">
      ...
      <div class="bg-yellow-500 bg-opacity-10 border border-yellow-500 border-opacity-30 rounded-[10px] p-3 mb-6">
        <p class="text-yellow-400 text-xs text-center">
          ⚠️ Этот код можно увидеть только один раз. 
  ...
  <transition name="fade">
    <div v-if="showContent" class="bg-[#111111] min-h-screen">
      ...
      <div class="pt-[60px] flex justify-between px-[250px]">
        ...
        <div class="w-[350px] h-fit bg-[#161616] border border-[#242627] rounded-[25px] mt-[80px] ml-[px] absolute">
          <div class="relative">
            <img :src="starsAdmin" alt="stars" class="absolute top-3 left-[10px]">
            <img :src="starsAdmin" alt="stars" class="absolute top-3 right-[10px]">
          </div>
          
          <b class="flex justify-center text-white font-exo font-[600] text-[18px] py-[9px]">
          ...
          <div class="p-[15px]">
            <div class="flex items-center mb-[10px]">
              <img :src="avatar" alt="avatar" class="w-[30px] h-[30px] rounded-full mr-[10px]">
              <div class="flex-1">
