<template>
  <div class="relative">
      ...
      >
        <div class="relative w-full h-full overflow-hidden">
          ...
          <div class="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center">
            <span class="text-white opacity-0 hover:opacity-100 font-exo font-semibold">Нажмите чтобы изменить шапку</span>
          </div>
        </div>
      </div>
    ...
    <div class="sm:hidden block">
      ...
      >
        <div class="relative w-full h-full overflow-hidden">
          ...
          />
          <div class="absolute inset-0 bg-black bg-opacity-0 hover:bg-opacity-30 transition-all duration-300 flex items-center justify-center">
            <span class="text-white text-xs text-center opacity-0 hover:opacity-100 font-exo font-semibold px-2">Нажмите чтобы изменить шапку</span>
          </div>
        </div>
      </div>
    ...
    <div v-if="showBannerEditor" class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
      <div class="bg-[#1A1A1A] rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <h3 class="text-white text-xl font-exo font-bold mb-4">Настройка шапки профиля</h3>
        
        <div class="flex flex-col lg:flex-row gap-6">
          <div class="flex-1">
            <div class="relative w-full h-48 border-2 border-[#D2EE5B] rounded-lg overflow-hidden">
              <img
                :src="headerPreview"
                alt="banner edit"
