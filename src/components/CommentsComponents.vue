...
<template>
  <div class="w-[1052px] bg-[#191919] rounded-2xl mt-[1px] mx-auto ml-[378.8px] p-4">
    ...
    <div v-if="!commentsHidden">
      ...
      >
        ...
        />
        <p class="font-exo text-white font-[600] text-[14px] ml-[60px] pt-[10px]">
          {{ comment.username }}
        </p>
        <p
        ...
        <p class="font-exo font-[400] text-white text-[14px] ml-[60px] -mt-[2px] whitespace-pre-wrap break-words">
          {{ comment.text }}
        </p>
      </div>
      ...
      <div class="mt-6">
        ...
        <div class="flex justify-between items-center mt-2">
          <span 
            ...
            :class="charCount > maxChars - 50 ? 'text-red-500' : 'text-[#878787]'"
          >
            {{ charCount }}/{{ maxChars }}
          </span>
    ...
    <div v-else class="text-center py-8">
      <p class="font-exo text-[#878787] text-[14px]">
        Комментарии скрыты
      </p>
      <button
        @click="toggleCommentsVisibility"
